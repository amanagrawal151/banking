...
const {addInterest, addFdInterest} = require("../controllers/interestController") ;
...
router.route("/addInterest/:id").post(addInterest) ;

router.route("/addFdInterest/:id").post(addFdInterest) ;
